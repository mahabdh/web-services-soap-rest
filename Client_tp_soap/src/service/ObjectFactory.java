...
public class ObjectFactory {
    ...
    private final static QName _ConversionMontantResponse_QNAME = new QName("http://service/", "conversionMontantResponse");
    ...
    private final static QName _ConversionMontant_QNAME = new QName("http://service/", "conversionMontant");
    ...
    /**
     * Create an instance of {@link ConversionMontantResponse }
     * 
     */
    public ConversionMontantResponse createConversionMontantResponse() {
        return new ConversionMontantResponse();
    }
    ...
    /**
     * Create an instance of {@link ConversionMontant }
     * 
     */
    public ConversionMontant createConversionMontant() {
        return new ConversionMontant();
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link ConversionMontantResponse }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://service/", name = "conversionMontantResponse")
    public JAXBElement<ConversionMontantResponse> createConversionMontantResponse(ConversionMontantResponse value) {
        return new JAXBElement<ConversionMontantResponse>(_ConversionMontantResponse_QNAME, ConversionMontantResponse.class, null, value);
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link ConversionMontant }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://service/", name = "conversionMontant")
    public JAXBElement<ConversionMontant> createConversionMontant(ConversionMontant value) {
        return new JAXBElement<ConversionMontant>(_ConversionMontant_QNAME, ConversionMontant.class, null, value);
    }
